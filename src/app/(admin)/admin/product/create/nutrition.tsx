    ...
    return (
        <>
            ...
            {formProduct.formState.errors.ingredients && (
                <div className="text-sm text-red-500 mt-1">{formProduct.formState.errors.ingredients.message as string}</div>
            )}
            {formProduct.formState.errors.servingSize && (
                <div className="text-sm text-red-500 mt-1">{formProduct.formState.errors.servingSize.message as string}</div>
            )}
            {formProduct.formState.errors.nutritionFacts && (
                <div className="text-sm text-red-500 mt-1">{formProduct.formState.errors.nutritionFacts.message as string}</div>
            )}
        </>
    )
}
