...
function AddressTab() {
    ...
    const [addressDelete, setAddressDelete] = useState<{ id: string, name: string } | undefined>(undefined)
                ...
                <div className="m-5 grid sm:grid-cols-3 gap-6">
                    {addresses?.value?.items.map((item: Address) => (
                        ...
                        >
                            ...
                            <p className="line-clamp-3 whitespace-pre-line">{item.receiverAddress}</p>
