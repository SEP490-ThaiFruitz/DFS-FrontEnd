...
const DialogProductBatchDetail = ({ onClose, isOpen, id }: Readonly<DialogProductBatchDetailProps>) => {
    const { data: productBatch } = useFetch<ApiResponse<ProductBatch>>(`/ProductBatches/${id}`, [PRODUCT_BATCH_KEY.PRODUCT_BATCH_DETAIL_MANAGE, id.toString()])
                                    ...
                                    <CardContent className="p-4 md:p-6 flex-1">
                                        <div className="flex flex-col h-full">
                                            <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-3 mb-4">
                                                ...
                                                : `/manager/product/${item.productId}`} className="font-medium text-lg hover:underline">
