...
function ProductVariantTab({ productVariants }: Readonly<ProductVariantProps>) {
    ...
    const { data: productVariantData, isLoading, refetch } = useFetch<ApiResponse<ProductDetail>>(`/Products/product-variants/${selectedVariantId}/batches/sales`, [PRODUCT_KEY.PRODUCT_VARIANT_DETAIL_STATISTIC], {}, { enabled: false })
    useEffect(() => {
