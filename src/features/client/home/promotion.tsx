...
const Promotion = () => {
    const { data: promotions } = useFetch<ApiResponse<FlashSale[]>>("/Promotions")
    return (
                    ...
                    >
                        ...
                        <div className="absolute inset-0 flex items-center justify-center p-6">
                            <div className="text-center bg-black/50 backdrop-blur-sm p-6 rounded-xl w-full max-w-md mx-4">
                                <h3 className="text-3xl font-bold text-white mb-2">{promotion.name}</h3>
                                <p className="text-gray-100 text-sm mb-4">{promotion.description}</p>
