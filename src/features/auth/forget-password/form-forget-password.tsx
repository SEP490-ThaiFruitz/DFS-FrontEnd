  ...
  const body = (
    <Tabs onValueChange={(e) => setTab(e as TabType)} value={tab}>
      <TabsContent value="send">
        <FormSendForgetPassword
          returnButton={retunrButton}
          setUsername={handlerSetUser}
        />
      </TabsContent>
      <TabsContent value="verify">
        <FormVerify
          returnButton={retunrButton}
          user={user}
          setOtpValue={handlerSetUser}
        />
      </TabsContent>
      <TabsContent value="new">
        <FormUpdateNewForgetPassword
          handlerSucess={handlerUpdateSuccess}
          returnButton={retunrButton}
          user={user}
        />
      </TabsContent>
