...
function CustomMap({ onLocationChange, defaultLocation }: Readonly<CustomMapProps>) {
    ...
    return (
        <div className="relative h-[500px] w-full">
            <LoadScript libraries={["places"]} googleMapsApiKey={process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY as string}>
                ...
                <GoogleMap
                    ...
                    center={currentPosition?.lat !== 0 && currentPosition?.lng !== 0 ? currentPosition : { lat: 10.8231, lng: 106.6297 }}
                    zoom={12}
                    onLoad={(map) => {
                        mapRef.current = map;
                    }}
