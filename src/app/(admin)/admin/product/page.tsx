...
function ProductPage() {
  ...
  return (
    <div className="m-10">
      ...
      {filter && (
        <div className="border p-5 rounded-lg shadow-sm mt-5 transform origin-top-right transition-all duration-5000 ease-in-out">
        ...
        <Table className="overflow-x-auto">
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="w-fit min-w-[120px]">
                Loại sản phẩm
              </TableHead>
              <TableHead className="w-fit min-w-[150px]">
                Tổng số lượng
              </TableHead>
