...
import { NUTRION_KEY } from '@/app/key/comm-key';
...
const NutritionFact = ({ formProduct }: Readonly<NutritionFactProps>) => {
    const { data: nutritions } = useFetch<ApiResponse<Nutrient[]>>("/Products/products/nutrients", [NUTRION_KEY.NUTRION_SELECT_MANAGE])
