...
export const ImageNotFound = ({
  ...
  return (
    ...
    >
      <rect width="1200" height="1200" fill={backgroundColor} rx="3" />
      <g opacity=".5">
        <g opacity=".5">
          <path
            fill="#FAFAFA"
        ...
        <path
          stroke={`url(#a-${elementColor.replace("#", "")})`}
          strokeWidth="2.418"
          d="M0-1.209h553.581"
          transform="scale(1 -1) rotate(45 1163.11 91.165)"
        />
        <path
          stroke={`url(#b-${elementColor.replace("#", "")})`}
          strokeWidth="2.418"
          d="M404.846 598.671h391.726"
        />
        <path
          stroke={`url(#c-${elementColor.replace("#", "")})`}
          strokeWidth="2.418"
          d="M599.5 795.742V404.017"
        />
        <path
          stroke={`url(#d-${elementColor.replace("#", "")})`}
          strokeWidth="2.418"
        ...
        />
        <g clipPath={`url(#e-${elementColor.replace("#", "")})`}>
          <path
            fill="#666"
            fillRule="evenodd"
      ...
      <defs>
        ...
        >
          <stop stopColor={elementColor} stopOpacity="0" />
          <stop offset=".208" stopColor={elementColor} />
          <stop offset=".792" stopColor={elementColor} />
          <stop offset="1" stopColor={elementColor} stopOpacity="0" />
        </linearGradient>
        <linearGradient
          id={`b-${elementColor.replace("#", "")}`}
          x1="796.912"
          x2="404.507"
          y1="599.963"
          y2="599.965"
        ...
        <clipPath id={`e-${elementColor.replace("#", "")}`}>
