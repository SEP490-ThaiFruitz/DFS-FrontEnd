...
import { PICKING_ITEM_KEY } from "@/app/key/comm-key"
...
const ListPickingItem = () => {
    const { data: pickingitems, isLoading } = useFetch<ApiResponse<ProductItem[]>>("/ProductBatches/pickingitems", [PICKING_ITEM_KEY.PICKING_ITEM_MANAGE])
...
export default ListPickingItem
