                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">{getRoleDisplay(request.user.role)}</p>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-3 mb-4">
                                            <Link href={
                                                user?.value?.role === 'Administrator'
                                                    ...
                                                    : `/manager/product/${variant.productId}`} className="font-medium text-lg hover:underline">
