...
import { CERTIFICATION_KEY, PRODUCT_KEY } from "@/app/key/comm-key"
...
const CertificationTab = ({ certificates: intial, productId }: Readonly<CertificationTabProps>) => {
    ...
    const { data: certifications } = useFetch<Certificate[]>("/Certifications", [CERTIFICATION_KEY.CERTIFICATION_MANAGE])
