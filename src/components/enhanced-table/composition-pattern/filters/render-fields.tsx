    ...
    case "date":
      ...
      return (
        <DatePicker
          ...
          setDate={(date) => updateFilterValue(column.id, date)}
        />
      );
    ...
    <div className="grid gap-4 py-4">
      {table
        ...
        .map((column) => {
          ...
          const availableFilterTypes = getColumnFilterTypesByValue(
            sampleValue,
            filter?.type
          );
