...
export const FormVerify = ({
    ...
    const { isPending, mutate: sendForgetPasswordCodeMutation } = useMutation({ mutationKey: ["ForgetPassword", "Mange"] })
    ...
    return <>
        ...
        <div className="pt-8">
            <div className="flex justify-center gap-x-2">
                <InputOTP onChange={(e) => setOtp(e)} disabled={isPending || isVerifying} maxLength={6} className="gap-x-2">
        ...
        <div className="flex gap-2 mt-5 items-center pb-8">
            <button disabled={time > 0} onClick={() => {
                ...
                setTime(30)
            }} className={`${time > 0 || isPending || isVerifying ? "hover:cursor-not-allowed" : "hover:font-bold hover:underline hover:cursor-pointer "}`}>
                Gửi lại OTP
            </button>
