...
import { PACKAGE_TYPE_KEY } from "@/app/key/comm-key"
...
const ConfirmInformation = ({ formProduct }: Readonly<ConfirmInformationProps>) => {
    ...
    const packageTypes = queryClient.getQueryData<ApiResponse<PackagingType[]>>([PACKAGE_TYPE_KEY.PACKAGE_TYPE_SELECT_MANAGE])
                                ...
                                <div className="p-4 space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <ImagePreview initialHeight={48} images={[variant.image[0].preview]} className="object-contain" />
                                        </div>
                                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-3">
                                            <div className="space-y-1">
                                                <h4 className="text-base font-medium text-muted-foreground">Khối lượng tịnh</h4>
                                                <div className="font-medium">{variant.netWeight}g</div>
                                            </div>
                                            <div className="space-y-1">
                                                <h4 className="text-base font-medium text-muted-foreground">Khối lượng tổng</h4>
                                                <div className="font-medium">{variant.grossWeight}g</div>
                                            </div>
                                            <div className="space-y-1">
                                                <h4 className="text-base font-medium text-muted-foreground">Giá</h4>
                                            ...
                                            <div className="space-y-1">
                                                <h4 className="text-base font-medium text-muted-foreground">Chiều dài</h4>
                                                <div>{variant.packagingLength}cm</div>
                                            </div>
                                            <div className="space-y-1">
                                                <h4 className="text-base font-medium text-muted-foreground">Chiều rộng</h4>
                                                <div>{variant.packagingWidth}cm</div>
                                            </div>
                                            <div className="space-y-1">
                                                <h4 className="text-base font-medium text-muted-foreground">Chiều cao</h4>
                                                <div>{variant.packagingHeight}cm</div>
                                            </div>
                                            <div className="space-y-1">
                                                <h4 className="text-base font-medium text-muted-foreground">Điểm cảnh báo</h4>
