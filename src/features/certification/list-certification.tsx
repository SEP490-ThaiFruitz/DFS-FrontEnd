...
const ListCertification = () => {
    const { data: certifications, isLoading } = useFetch<Certification[]>("/Certifications", [CERTIFICATION_KEY.CERTIFICATION_MANAGE])
        ...
        <div className="m-10">
            ...
            {certificationRemove && (
                <DeleteDialog
                    ...
                    refreshKey={[[CERTIFICATION_KEY.CERTIFICATION_MANAGE]]}
                />
            )}
            {certificationEdit && (
                <FormCertification
