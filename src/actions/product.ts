...
export const createNutritionFact = async <TValue>(values: TValue, productId: string) => {
    return await interactApi.post(`/Products/products/${productId}/nutrition/facts`, values);
}

export const updateNutritionFact = async <TValue>(values: TValue, nutritionFactId: string) => {
    return await interactApi.put(`/Products/nutrition-facts/${nutritionFactId}`, values);
}
...
export const createCertificate = async <TValue>(values: TValue, productId: string) => {
    return await interactApi.post(`/Products/products/${productId}/certifications`, values);
}

export const updateCertificate = async <TValue>(values: TValue, productCertificationId: string) => {
    return await interactApi.put(`/Products/certifications/${productCertificationId}`, values);
}
